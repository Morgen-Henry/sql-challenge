...
Found on: ERD.png
Depicts the relationships between all tables used.

# Data Engineering
Found on: SQL_Challenge.sql
SQL file that creates tables
Data was then imported from Resources folder to use for later analysis

# Data Analysis
Found on: SQL_Challenge_2.sql
Utilizing data from tables created in previous file
SQL file that lists:
